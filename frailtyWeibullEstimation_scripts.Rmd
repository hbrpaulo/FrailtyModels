...
source("../scripts/R/analysis/baseline_weibull.R")
source("../scripts/R/analysis/simulate_frailty.R")
source("../scripts/R/analysis/estimate_frailty_mle.R")
source("../scripts/R/analysis/coverage_study.R")
source("../scripts/R/analysis/funnel_plot.R")
source("../scripts/R/analysis/wrapper_pipeline.R")
```
