...
```{r}
set.seed(1)
rgamma(10, shape=2, rate=2)  # Example of generating random numbers from a Gamma distribution
set.seed(1)
rgamma(10, shape=2, scale=1/2)  # Example of generating random numbers from a Gamma distribution with scale
```
...
set.seed(123)
N_values <- c(10, 100, 200, 100, 5000)
